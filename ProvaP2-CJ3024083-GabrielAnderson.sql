...
-- Nome do aluno: Gabriel Anderson
...
CREATE DATABASE LOJAMARIA3024083;
GO


-- Habilita o contexto do banco de dados
USE LOJAMARIA3024083;
GO
...
select NumeroPedido as 'Número do Pedido',
	count [CodigoProduto] as 'Quantidade de itens diferentes',
	Quantidade
from itens_de_pedidos;
go
...
select CodigoCliente as 'Código do cliente',
	...
	DescricaoProduto as 'Nome do produto',
	ValorUnitario as 'Preço Unitário',
	Quantidade,
	PrazoEntrega as 'Prazo de entrega',
	NomeVendedor as 'Nome do vendedor'
where CLIENTES inner join Pedidos
